...
public class JwtTokenUtil implements Serializable {
    ...
    //for retrieving any information from token we will need the secret id
	...
	//2. Sign the JWT using the HS512 algorithm and secret id.
	//3. According to JWS Compact Serialization(https://tools.ietf.org/html/draft-ietf-jose-json-web-signature-41#section-3.1)
	//   compaction of the JWT to a URL-safe string 
	private String doGenerateToken(String id) {
	...
	//validate token
	public Boolean validateToken(String token, Integer subject) {
